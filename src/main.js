...
// 점수 / 게임오버
// ---------------------------------------------------------------------------
const game = { score: 0, sec: 0, diamonds: MAX_DIAMONDS, best: 0, over: false, paused: false, started: false, grace: 0 };
...
function togglePause() {
  ...
  if (!game.paused) game.grace = START_GRACE; // 재개 후 5초간 충돌 면제
